...
= 1.3.3 (March 2026) =
* Security: Added CSRF fix with nonce verification on visualization toggle.
* Security: Added capability gate before hook attachment.
* Security: Applied wp_nonce_url on admin bar links.
* Security: Added uninstall.php for clean plugin removal.
